...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if(!canalNotificaciones) return message.reply(`<:VS_cancel:1006609599199186974> **No has especificado un canal de notificaciones al subir de nivel!**`);

        const mensaje = args.slice(1).join(" ").substring(0, 2048);
        if(!mensaje) return message.reply(`<:VS_cancel:1006609599199186974> **No has especificado un mensaje cuando un usuario sube de nivel!**`);

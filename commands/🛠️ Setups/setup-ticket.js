            ...
            if(channel) {
                ...
                await quemensaje.channel.awaitMessages({
                    ...
                    const msg = await message.guild.channels.cache.get(objeto.canal).send({
                        ...
                        components: [new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder().setLabel("Crea un ticket").setEmoji("1010950503787659388").setCustomId("crear_ticket").setStyle("Success"))]
                    })

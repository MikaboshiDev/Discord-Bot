...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        if(!args.length) return message.reply(`<:VS_cancel:1006609599199186974> **Tienes que especificar el canal de sugerencias!**`)
        ...
        if(!channel || channel.type !== 0) return message.reply(`<:VS_cancel:1006609599199186974> **El canal de sugerencias que has mencionado no existe!**`);

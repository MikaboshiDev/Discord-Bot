...
async function asegurar_todo(guildid, userid) {
    if (guildid) {
        ...
        if (!serverdata) {
            console.log(`[Systema World] Config de Server`.green);
        ...
        if (!setupsdata) {
            console.log(`[Systema World] Setups`.green);
    ...
    if (userid) {
        ...
        if (!ecodata) {
            console.log(`[Systema World] Economia de ${userid}`.green);
    ...
    if(guildid && userid){
        ...
        if (!warn_data) {
            console.log(`[Systema World] Warnings de ${userid} en ${guildid}`.green);
